...
function enterFps(isSimulation = false, options = {}) {
  clearVictoryBanner(); stopLobbyMusic(); ensureFpsPlayers(game.playerCount);
  ...
  game.ammo = freshAmmoState(); game.reloading = false; game.reloadTimer = 0; game.reloadWeapon = null; game.activeWeapon = startAsMelee ? "melee" : "gun"; game.primaryWeapon = startingWeapon; game.meleeSwingTimer = 0; game.parryCooldown = 0; game.parryReloadTotal = 0; game.parryAnimTimer = 0; game.throwTimer = 0; game.throwBlockTimer = 0; game.throwKind = ""; game.weaponSwapTimer = 0; game.jumpCooldown = 0; game.healCooldown = 0; game.grenadeCooldown = 0; game.smokeCooldown = 0; game.radarCooldown = 0; game.radarTimer = 0; game.slideTimer = 0; game.slideCooldown = 0; game.visualRecoil = 0; game.dashCooldown = 0; game.dashTimer = 0; game.grappleCooldown = 0; game.scopeAmount = 0; releaseGrapple?.();
